...
void main(void) {
    ...
    USART2->CTLR1 &= (uint16_t)~(0x1000 | 0x0400 | 0x0200); 
    USART2->CTLR2 &= (uint16_t)~0x3000; 

    /* Enable TX, RX, USART */
    USART2->CTLR1 |= (uint16_t)(0x0008 | 0x0004 | 0x2000);
